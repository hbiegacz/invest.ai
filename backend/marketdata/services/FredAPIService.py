...
class FredAPIService:
    ...
    def get_basic_economic_data(self):
        ...
        unemploy_data = self._get(endpoint, params={"series_id": "UNRATE",   "sort_order": "desc", "limit": 1})
        gdp_data =      self._get(endpoint, params={"series_id": "GDP",      "sort_order": "desc", "limit": 1})

        latest_unemploy = unemploy_data["observations"][0] if unemploy_data["observations"] else {}
